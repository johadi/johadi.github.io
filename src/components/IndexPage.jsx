    ...
    <div className="container-wrap">
      ...
      <aside id="colorlib-aside" role="complementary" className="border js-fullheight">
        ...
        <div className="colorlib-footer">
          <ul>
            <li><a href="#"><i className="icon-facebook2 text-primary"></i></a></li>
            <li><a href="#"><i className="icon-twitter2 text-primary"></i></a></li>
            <li><a href="#"><i className="icon-instagram text-primary"></i></a></li>
            <li><a href="#"><i className="icon-linkedin2 text-primary"></i></a></li>
          </ul>
        </div>
                    ...
                    <div
                      ...
                      <div className="slider-text-inner js-fullheight">
                        <div className="desc">
                          ...
                          <h2>a passionate and result-oriented software developer with 5+ years experience in programming</h2>
                ...
                <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                  <div className="col-md-12">
                    <div className="about-desc">
                      ...
                      <p><strong>Hi I'm Jimoh Hadi</strong> I'm a passionate and result-oriented software developer
                        with 5 years hands-on experience using JavaScript frameworks/libraries/tools:
                        NodeJS, ReactJS, Angular 6, React Native, jQuery, Babel, Webpack, etc. I have Bsc. in
                        Computer Science with strong background in programming, and considerable experience
                        using cutting-edge software development tools. .</p>
                  ...
                  <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div className="panel panel-default">
                      <div className="panel-heading" role="tab" id="headingTwo">
                        <h4 className="panel-title">
                          <a className="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"
                             aria-expanded="false" aria-controls="collapseTwo">Bachelor Degree of Computer Science
                          </a>
                        </h4>
                      </div>
                      <div id="collapseTwo" className="panel-collapse collapse" role="tabpanel"
                        ...
                        <div className="panel-body">
                          <p>Far far away, behind the word <strong>mountains</strong>, far from the countries Vokalia
                      ...
                      <div className="panel-heading" role="tab" id="headingThree">
                        <h4 className="panel-title">
                          <a className="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree"
                             aria-expanded="false" aria-controls="collapseThree">Diploma in Information Technology
                          </a>
                        </h4>
                      </div>
                    ...
                    <div className="panel panel-default">
                      <div className="panel-heading" role="tab" id="headingFour">
                        <h4 className="panel-title">
                          <a className="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour"
                             aria-expanded="false" aria-controls="collapseFour">Diploma in Information Technology
                          </a>
                        </h4>
                      </div>
                    ...
                    <div className="panel panel-default">
                      <div className="panel-heading" role="tab" id="headingFive">
                        <h4 className="panel-title">
                          <a className="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive"
                             aria-expanded="false" aria-controls="collapseFive">High School Secondary Education
                          </a>
                        </h4>
                      </div>
            ...
            <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
              <div className="col-md-12">
                <p className="work-menu"><span><a href="#" className="active">Graphic Design</a></span> <span><a
                  href="#">Web Design</a></span> <span><a href="#">Software</a></span> <span><a href="#">Apps</a></span>
                </p>
              </div>
            </div>
            <div className="row">
              ...
              <div className="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                <div className="project" style={{ backgroundImage: 'url(/template-assets/images/img-5.jpg)' }}>
                  <div className="desc">
                    <div className="con">
              ...
              <div className="col-md-6 animate-box" data-animate-effect="fadeInRight">
                <div className="project" style={{ backgroundImage: 'url(/template-assets/images/img-6.jpg)' }}>
                  <div className="desc">
                    <div className="con">
            ...
            <div className="row">
              <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
                <div className="blog-entry">
                  <a href="blog.html" className="blog-img"><img src="/template-assets/images/blog-1.jpg"
              ...
              <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInRight">
                <div className="blog-entry">
                  <a href="blog.html" className="blog-img"><img src="/template-assets/images/blog-2.jpg"
                                                                className="img-responsive"
                                                                alt="HTML5 Bootstrap Template by colorlib.com"/></a>
                  <div className="desc">
                    <span><small>April 14, 2018 </small> | <small> Web Design </small> | <small> <i
              ...
              <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
                <div className="blog-entry">
                  <a href="blog.html" className="blog-img"><img src="/template-assets/images/blog-3.jpg"
                                                                className="img-responsive"
                                                                alt="HTML5 Bootstrap Template by colorlib.com"/></a>
                  <div className="desc">
